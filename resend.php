...
move_uploaded_file($paper_pdf_tem, "corrected_pdf/$paper_pdf");
   
// $sqli = "INSERT INTO `addpaper` ( `correct_paper`,  `check_date`) VALUES (  '$paper_pdf','$sub_date')";
$sqli = "UPDATE addpaper SET paper_corrected='$paper_pdf',paer_c_date = '$$papar_c_date' WHERE id = '$add'";
...
<form id="form1"  method="post" action="resend.php?resend=<?php echo $add; ?>" enctype="multipart/form-data">
...
<div class="audit_sm" style = "background: #FBFBFB;"> <h4>Send corrected paper</h4></div>
