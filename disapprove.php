...
$add = $_GET['disadd'];   
  if(isset($_POST['disapprove'])){    
                $sqlli = "UPDATE addpaper SET status = 2 WHERE id = '$add'";
        ...
        ?>
           <tr>   
            ...
            ?>
                ...
                <form action = "disapprove.php?disadd=<?php echo $article['id'];?>" method = "post" >
              
                    <td><input class = "btn btn-danger" type = "submit" name = "disapprove" value = "DSP"></td>
                    
                    </form>
               <div class = "mb-4">
               <h4> <b>Are you sure you want to disapprove?</b></h4>
                <div>
