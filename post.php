...
move_uploaded_file($journal_cover2, "image/$journal_cover");
...
echo "<div class='alert alert-danger' role='alert' aria-label='Close'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><strong>'$journal_slug'</strong> slug already exist</div>";} 
  ...
  //  elseif(!move_uploaded_file($journal_cover2, "./image/$journal_cover")){
  //   echo "<div class='alert alert-danger' role='alert' aria-label='Close'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><strong>'Image not moved</div>"; } 

    else {
$sql = "INSERT INTO `opaar_journal` (`id`, `user_id`, `journal_title`, `journal_slug`, `journal_cover`, `online_issn`, `print_issn`, `journal_description`,`journal_study`, `journal_date`, `journal_meta`, `journal_status`, `journal_trash`, `user_ip`) VALUES (NULL, '$journal_author', '$journal_title', '$journal_slug', '$journal_cover', '$journal_online_issn', '$journal_print_issn', '$journal_discription','$journal_study', '$journal_date', '$journal_meta', '$journal_status', '$journal_trash', '$user_ip') ";
...
<head>
    ...
    <title>OJS: Create Journal</title>
</head>
<body>
...
<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
 ...
 <div class="col">
    <div class="form-group">
      <label for="company" class=" form-control-label"> <small class="text-muted">Journal Title</small></label>
      <input type="text" id="journal_title" name="journal_title" placeholder="Enter Journal Title Here.." class="form-control" required> 
    </div> 
...
?>
    ...
    <div class="form-group">
      ...
      <label for="company" class=" form-control-label"> <small class="text-muted">Under which Study</small></label>
    <div>
      <select required class = "chosen-select" name="study">
      <option  value = "">  </option>
        <option value = "Physical Science and engeenering"  > Physical Science and engeenering </option>
